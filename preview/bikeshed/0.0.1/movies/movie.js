...
var rect1 = bikeshed.Shape.rect(0,0,100,100).attr({ fillColor: 'red' });
stage.addChild(rect1);

/* create rect and add it to movie immediately, but do not add movie for now */
var movie = new bikeshed.Movie();
var rect2 = bikeshed.Shape.rect(0,0,100,100).attr({ fillColor: 'green', x: 10, y: 10 });
