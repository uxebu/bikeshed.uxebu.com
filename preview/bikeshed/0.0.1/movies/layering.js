...
var shape1 = new bikeshed.Shape.rect(0, 0, 100, 100).attr({fillColor: 'red'});
var shape2 = new bikeshed.Shape.rect(25,25, 100, 100).attr({fillColor: 'green'});
var shape3 = new bikeshed.Shape.rect(50, 50, 100, 100).attr({fillColor: 'yellow'});
...
var red = Shape.rect(0,0,100,100).attr('fillColor', 'red');
var blue = Shape.rect(25,25,100,100).attr('fillColor', 'blue');
var orange = Shape.rect(50,50,100,100).attr('fillColor', 'orange');
