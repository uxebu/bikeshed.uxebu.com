...
var group2 = new bikeshed.Group();
[
  bikeshed.Shape.rect(20,20,100,100).attr({fillColor:'green'}),
  bikeshed.Shape.rect(30,30,100,100).attr({fillColor:'yellow'}),
  bikeshed.Shape.rect(40,40,100,100).attr({fillColor:'gray'})
