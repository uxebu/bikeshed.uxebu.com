...
var breakout = {
    ...
    createBlocks: function (){
        ...
        for (var i=0, m=blockCount; i<m; i++) {
            ...
            var block = bikeshed.Shape.rect(0,0,blockWidth,blockHeight)
    ...
    createPaddle: function() {
        this.paddle = bikeshed.Shape.rect(0,0,150,10).attr({fillColor: 'black'});
    ...
    createBall: function() {
        this.ball = bikeshed.Shape.circle(0,0,5).attr({fillColor: 'red'});
