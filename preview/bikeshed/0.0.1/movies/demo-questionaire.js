...
(function(){
  ...
  background.update = function(buttonObj){
    var bg = new bikeshed.Shape.rect(lastX, lastY, 1, height).attr({fillColor: buttonObj.bgColor, opacity: 0.2});
    stage.addChild(bg, 0);
...
(function(){
  ...
  pieChart.init = function(buttonObj){
    ...
    bikeshed.Shape.circle(pos.x, pos.y, 119)
